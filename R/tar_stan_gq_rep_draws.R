...
#' @return `tar_stan_gq_rep_draws(name = x, stan_files = "y.stan")`
...
tar_stan_gq_rep_draws <- function(
  ...
  args <- list(
    call_ns("stantargets", "tar_stan_gq_rep_draws_run"),
...
tar_stan_gq_rep_draws_run <- function(
  stan_file,
  stan_name,
  stan_path,
  data,
...
tar_stan_gq_rep_draws_run_rep <- function(
  data,
  seed,
  model,
  fitted_params,
