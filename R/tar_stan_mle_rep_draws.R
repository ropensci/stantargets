#' @title Multiple optimization runs (wide form).
#' @export
...
#' @return `tar_stan_mle_rep_draws(name = x, ...)` returns a list
...
#'   * `x`: dynamic branching target with wide-form data frames of MLEs.
